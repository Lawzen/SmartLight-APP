    ...
    useEffect(() => {
        const fetchPreset = async () => {
            try {
                ...
                console.error("Erreur de chargement du preset:", error)
                toast.error("Erreur de chargement du preset")
            } finally {
                setIsLoading(false)
            }
        }
        ...
        <div className="min-h-screen bg-gradient-to-br from-base-200 to-base-300 p-6">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold ml-4">Modifier le preset</h1>
                </div>
                ...
                <div className="mt-8 text-center text-base-content/70">
                    <p>Modifiez votre ambiance lumineuse pour votre ampoule connectée</p>
                </div>
            </div>
        </div>
    )
